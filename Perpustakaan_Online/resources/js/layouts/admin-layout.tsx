...
import { BookOpen, BarChart3, Plus, Settings, User, LogOut, Menu, X, ShieldCheck, MessageSquare } from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    const adminNavItems = [
        ...
        { name: 'Add New Book', href: '/admin/books/create', icon: Plus },
        { name: 'Analytics', href: '/admin/analytics', icon: BarChart3 },
        { name: 'Manage Reviews', href: '/admin/reviews', icon: MessageSquare },
    ];

    const userMenuItems = [
        { name: 'View as User', href: '/dashboard', icon: User },
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
                ...
                <div className="container mx-auto px-4 py-4 flex items-center justify-between">
                    ...
                    <Link href="/admin/dashboard" className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-purple-300">Bookify Hub</p>
                        </div>
                    </Link>
                    ...
                    <div className="hidden lg:flex items-center gap-3">
                        ...
                        {user ? (
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent className="w-64 bg-slate-900 border-purple-500/30" align="end" forceMount>
                                    <DropdownMenuLabel className="font-normal">
                                        <div className="flex flex-col space-y-1">
                                            <div className="flex items-center gap-2">
                                                <p className="text-sm font-medium leading-none text-white">{user.name}</p>
                                                <span className="px-2 py-0.5 text-xs font-semibold rounded-full bg-purple-500/20 text-purple-300">
                                                    ADMIN
                                                </span>
                                            </div>
                ...
                <AnimatePresence>
                    {isMobileMenuOpen && (
                        <motion.div
                            ...
                            className="lg:hidden bg-slate-900/95 border-t border-purple-500/20"
                        >
            ...
            {/* Modern Footer */}
            <footer className="bg-slate-900/50 border-t border-purple-500/20 py-6 backdrop-blur-sm">
                <div className="container mx-auto px-4 max-w-7xl">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-2">
                            <ShieldCheck className="h-5 w-5 text-purple-400" />
                            <span className="text-sm text-purple-300">
                                Bookify Hub Admin Panel
                            </span>
                        </div>
